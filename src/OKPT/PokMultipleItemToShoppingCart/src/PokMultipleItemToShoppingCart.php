...
namespace PokMultipleItemToShoppingCart;
...
use PokMultipleItemToShoppingCart\Service\CustomFieldsInstaller;

class PokMultipleItemToShoppingCart extends Plugin
{
