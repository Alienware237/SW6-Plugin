...
CREATE TABLE `order_transaction_capture_refund` (
    ...
    `capture_version_id` BINARY(16) NOT NULL,
    `state_id` BINARY(16) NOT NULL,
    `external_reference` VARCHAR(255) NULL,
    ...
    CONSTRAINT `fk.order_transaction_capture_refund.capture_id` FOREIGN KEY (`capture_id`,`capture_version_id`) REFERENCES `order_transaction_capture` (`id`,`version_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_transaction_capture_refund_position` (
    ...
    `refund_version_id` BINARY(16) NOT NULL,
    `order_line_item_id` BINARY(16) NOT NULL,
    `order_line_item_version_id` BINARY(16) NOT NULL,
    `external_reference` VARCHAR(255) NULL,
    `reason` VARCHAR(255) NULL,
    ...
    KEY `fk.order_transaction_capture_refund_position.order_transaction_capture_refund.id` (`order_transaction_capture_refund.id`,`refund_version_id`),
    ...
    CONSTRAINT `fk.order_transaction_capture_refund_position.order_transaction_capture_refund.id` FOREIGN KEY (`order_transaction_capture_refund.id`,`refund_version_id`) REFERENCES `order_transaction_capture_refund` (`id`,`version_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
