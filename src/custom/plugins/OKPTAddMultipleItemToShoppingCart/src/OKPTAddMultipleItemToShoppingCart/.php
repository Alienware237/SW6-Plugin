...
namespace OKPT\AddMultipleItemToShoppingCart;
...
use OKPT\AddMultipleItemToShoppingCart\Service\CustomFieldsInstaller;

class OKPTAddMultipleItemToShoppingCart/ extends Plugin
{
